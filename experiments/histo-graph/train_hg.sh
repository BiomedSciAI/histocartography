...
# export experiment 
export MLFLOW_EXPERIMENT_NAME=gja_bach_hact_4
	...
	do
		...
		do
			...
			bsub -R "rusage [ngpus_excl_p=1]" \
			    ...
			    -q "$queue" \
			    "python train_histo_graph_cv.py --data_path /dataT/pus/histocartography/Data/BACH/train -conf ../../histocartography/config/$BASE_CONFIG/$conf -l $lr -b $bs --epochs 100 --in_ram"
			sleep 0.1 
		done 
	done
done
