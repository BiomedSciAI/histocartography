...
def get_s3(endpoint_url='http://data.digital-pathology.zc2.ibm.com:9000',
    ...
    if aws_access_key_id is None or aws_secret_access_key is None:
        try:
            ...
            log.error("No credentials for %s. Set Environment Variables",
                      endpoint_url)
...
def download_file_to_local(s3=None,
...
def save_local_file(local_file, s3=None, bucket_name=None, s3file=None):
    ...
    try:
        ...
        log.debug("{} saved to {}/{} as {}".format(local_file, s3, bucket_name,
                                                   s3file))
    except Exception as e:
        log.error("Error saving {} to {}/{} as {}".format(
