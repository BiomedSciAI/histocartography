...
#              -q "$queue" \
#              "python build_graph.py --data_path /dataT/pus/histocartography/Data/BACH/test --save_path /dataT/pus/histocartography/Data/BACH/test --features_used $f --configuration $config"
#              sleep 0.1
# done
...
#          -e "runs/lsf_logs.%J.stderr" \
#          -q "$queue" \
#          "python build_graph.py --data_path /dataT/pus/histocartography/Data/BACH/test --save_path /dataT/pus/histocartography/Data/BACH/test --features_used blabla --configuration $config"
#          sleep 0.1
