...
class ModuleTestCase(unittest.TestCase):
    ...
    def test_small_pipeline(self):
        ...
        # raw_mask, mask = get_annotation_mask(
        ...
        # patch_info_coordinates = get_patches(
        #     image_id='tmp/patches_output',
        #     image=image,
        #     patch_size=128,
        #     visualize=1)

        # y_pred = predict_for_image(patch_info_coordinates, image, model_json,
        #                            model_weights, 1)
