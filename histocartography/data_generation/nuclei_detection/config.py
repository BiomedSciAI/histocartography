...
class Config(object):
    def __init__(self, args):
        ...
        if self.data_param == 'local':
            ...
            self.base_image_dir = self.base_path + 'PASCALE/Images_norm/' + self.tumor_type + '/'
            self.inf_model_path = self.base_path + 'PASCALE/misc_utils/nuclei_detection/hover_seg_Kumar.npz'
            ...
            self.base_image_dir = self.base_path + 'BRACS_L/Images_norm/' + self.tumor_type + '/'
            ...
            self.inf_model_path = self.base_path + 'BRACS_L/misc_utils/nuclei_detection/hover_seg_Kumar.npz'
        ...
        self.centroid_output_dir = self.nuclei_detected_path + 'centroids/' + self.tumor_type + '/'
        self.map_output_dir = self.nuclei_detected_path + 'instance_map/' + self.tumor_type + '/'
