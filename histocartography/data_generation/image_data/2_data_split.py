...
def select_ids(split_number):
    if split_number == 1:
        val_ids = [283, 743, 747, 750, 754, 760, 1231, 1232, 1242, 1253, 1289, 1292, 1293, 1366, 1358]
        test_ids = [281, 286, 291, 301, 739, 753, 757, 1286, 1255, 1257, 1296, 1319, 1337, 1368, 1369]
    elif split_number == 2:
        val_ids = [264, 288, 292, 295, 738, 740, 755, 756, 762, 1235, 1238, 1283, 1356, 1360]
        test_ids = [281, 286, 291, 301, 739, 753, 757, 1286, 1255, 1257, 1296, 1319, 1337, 1368, 1369]
    elif split_number == 3:
        val_ids = [265, 297, 305, 311, 735, 736, 737, 745, 752, 759, 761, 1272, 1288, 1263, 1271, 1325, 1330, 1334, 1335, 1395, 1416]
        test_ids = [281, 286, 291, 301, 739, 753, 757, 1286, 1255, 1257, 1296, 1319, 1337, 1368, 1369]
    elif split_number == 4:
        val_ids = [281, 286, 291, 301, 739, 753, 757, 1286, 1255, 1257, 1296, 1319, 1337, 1368, 1369]
        test_ids = [283, 743, 747, 750, 754, 760, 1231, 1232, 1242, 1253, 1289, 1292, 1293, 1366, 1358]
    elif split_number == 5:
        val_ids = [264, 288, 292, 295, 738, 740, 755, 756, 762, 1235, 1238, 1283, 1356, 1360]
        test_ids = [283, 743, 747, 750, 754, 760, 1231, 1232, 1242, 1253, 1289, 1292, 1293, 1366, 1358]
    elif split_number == 6:
        ...
        val_ids = [281, 286, 291, 301, 739, 753, 757, 1286, 1255, 1257, 1296, 1319, 1337, 1368, 1369]
        test_ids = [264, 288, 292, 295, 738, 740, 755, 756, 762, 1235, 1238, 1283, 1356, 1360]
    elif split_number == 8:
        val_ids = [283, 743, 747, 750, 754, 760, 1231, 1232, 1242, 1253, 1289, 1292, 1293, 1366, 1358]
        test_ids = [264, 288, 292, 295, 738, 740, 755, 756, 762, 1235, 1238, 1283, 1356, 1360]
    elif split_number == 9:
        ...
        val_ids = [281, 286, 291, 301, 739, 753, 757, 1286, 1255, 1257, 1296, 1319, 1337, 1368, 1369]
        test_ids = [265, 297, 305, 311, 735, 736, 737, 745, 752, 759, 761, 1272, 1288, 1263, 1271, 1325, 1330, 1334, 1335, 1395, 1416]
...
save_path = base_path + 'data_splits/data_split_' + str(args.split_number) + '/'
