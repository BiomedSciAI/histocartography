...
# export experiment 
export MLFLOW_EXPERIMENT_NAME=gja_gnn_cell_classifier
	...
	do
		...
		do
			...
			bsub -R "rusage [ngpus_excl_p=1]" \
				...
				-q "$queue" \
				"python train_histo_nuclei.py --data_path /dataT/pus/histocartography/Data/BRACS_L/ -conf ../../histocartography/config/$BASE_CONFIG/$conf -l $lr -b $bs --epochs 100 --in_ram"
			sleep 0.1 
		done 
	done
done
