...
class PretrainedVAE(nn.Module):
    ...
    def __init__(self, encoder, encoder_output_dim, embedding_dim, device):
        ...
        self._decoder_input_dim = self._upsample_filters[0] * \
...
if __name__ == '__main__':
    ...
    model = pretrained_vae(
        encoder=encoder,
        encoder_output_dim=num_features,
        embedding_dim=16)
