"""
Implementation of a GIN (Graph Isomorphism Network) layer with the representation from a lower level graph included.
...
class PooledGINLayer(BaseLayer):
    ...
    def __init__(
        ...
        """
        super(PooledGINLayer, self).__init__(node_dim, hidden_dim, out_dim, act, layer_id)
    ...
    def msg_fn(self, edges):
        ...
        """
        return {GNN_MSG: edges.src[GNN_NODE_FEAT_IN]}
