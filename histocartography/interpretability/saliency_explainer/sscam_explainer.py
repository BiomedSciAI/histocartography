...
class SSCAMGNNExplainer(BaseExplainer):
    def __init__(
            self,
            model,
            config,
        ...
        """
        super(SSCAMGNNExplainer, self).__init__(model, config, cuda, verbose)
    ...
    def explain(self, data, label):
        ...
        while x <= w:
            ...
            while y <= h:
                ...
                extractor = SSCAM(self.model, self.conv_layer, self.input_layer)
